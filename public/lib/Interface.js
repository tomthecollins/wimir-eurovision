// Globals are Tone and StartAudioContext.
var Interface = {
	isMobile: false,
	isFirefox: false
};

// Page refresh will scroll back to top.
...
$(function(){
	...
	if( /Firefox/i.test(navigator.userAgent) ){
		Interface.isFirefox = true;
	}
	// Mobile and Chrome start
	if( /Chrome|Safari|Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ){
